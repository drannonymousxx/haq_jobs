 ...
 * Uses the official multicolor Google "G" SVG logo.
 *
 * Props:
...
export default function GoogleAuthButton({
  ...
  return (
    ...
    >
      <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
