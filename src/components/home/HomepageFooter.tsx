...
export function HomepageFooter() {
  ...
  return (
    <footer className="relative w-full overflow-hidden bg-[#0B0B0B] p-3 sm:p-4 md:p-6 lg:p-8 mt-12">
          ...
          <motion.div variants={navColumnVariants} className="space-y-4">
            ...
            <ul className="space-y-3.5 text-xs sm:text-sm font-semibold text-[#CBD5E1]/60">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@haqjobs.com" className="hover:text-white transition-colors duration-200">
                  info@haqjobs.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={14} className="text-[#B63106] shrink-0" />
                <span>+91 22 6678 9012</span>
              </li>
            </ul>
          </motion.div>
        </div>
