      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="flex-1 max-w-xl">
          <motion.h2 
            ...
            className="text-3xl md:text-4xl font-bold text-brand-text mb-6 leading-tight"
          >
          ...
          <motion.p 
            ...
            className="text-lg text-brand-text/70 mb-8"
          >
          ...
          >
            {[
              ...
              <li key={i} className="flex items-center gap-3 text-brand-text/80">
                <CheckCircle2 size={20} className="text-[#B63106]" />
                <span>{item}</span>
              </li>
            ))}
          </motion.ul>
        ...
        <div className="flex-1 relative w-full h-[450px] lg:h-[550px] flex items-center justify-center">
          ...
          <div className="absolute inset-0 bg-gradient-to-tr from-[#B63106]/10 to-transparent rounded-full blur-3xl opacity-60" />
          ...
          <motion.div 
            ...
            className="absolute z-10 w-[90%] md:w-[80%] max-w-md bg-brand-card/80 backdrop-blur-xl border border-white/40 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] rounded-3xl p-6"
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#B63106] to-[#B63106]/70" />
                <div>
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center justify-between p-3 rounded-2xl bg-[#F0F0F0]/50 border border-[#191D20]/5">
                  <div className="flex items-center gap-3">
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${i === 1 ? 'bg-blue-100 text-[#B63106]' : i === 2 ? 'bg-emerald-100 text-emerald-600' : 'bg-purple-100 text-purple-600'}`}>
                  ...
                  <div className="w-16 h-6 rounded-full bg-brand-card border border-[#191D20]/5 flex items-center justify-center">
                    <div className="w-8 h-1.5 bg-[#B63106]/30 rounded-full" />
                  </div>
                </div>
              ))}
            </div>
          ...
          <motion.div 
            ...
            className="absolute z-20 top-12 -right-4 md:right-0 bg-brand-card/90 backdrop-blur-md border border-white shadow-[0_15px_35px_-5px_rgba(0,0,0,0.08)] rounded-2xl p-4 w-48"
          >
            <div className="text-xs font-semibold text-brand-text/60 mb-2 uppercase tracking-wider">Profile Strength</div>
            <div className="flex items-end gap-2 mb-2">
              <div className="text-2xl font-bold text-[#B63106]">85%</div>
            ...
            <div className="w-full h-2 bg-[#F0F0F0] rounded-full overflow-hidden">
              <motion.div 
                ...
                className="h-full bg-[#B63106] rounded-full" 
              />
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="relative flex h-8 w-8">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#B63106] opacity-40"></span>
                <span className="relative inline-flex rounded-full h-8 w-8 bg-[#B63106] border-2 border-[#191D20]"></span>
              </div>
