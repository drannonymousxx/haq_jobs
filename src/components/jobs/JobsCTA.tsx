    ...
    <section className="py-20 bg-brand-card">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
        <motion.div
          ...
          className="bg-brand-card rounded-[2rem] md:rounded-[3rem] border border-[#B63106]/25 shadow-[0_20px_60px_-15px_rgba(182, 49, 6,0.08)] overflow-hidden flex flex-col md:flex-row relative"
        >
          {/* Illustration Panel */}
          <div
          ...
          >
            ...
            <div className="absolute w-[200px] h-[200px] bg-[#B63106] opacity-[0.03] rounded-full blur-3xl top-0 left-0 pointer-events-none" />
            <div className="absolute w-[150px] h-[150px] bg-brand-card opacity-[0.6] rounded-full blur-2xl bottom-0 right-0 pointer-events-none" />
            ...
            <div className="relative w-full aspect-square max-w-[280px]">
              ...
              <motion.div
                ...
                className="absolute bottom-10 left-1/2 -translate-x-1/2 w-48 h-16 bg-gradient-to-b from-[#FFFFFF] to-[#EEF2FF] rounded-2xl shadow-[0_20px_40px_-10px_rgba(182, 49, 6,0.15)] transform -rotate-6"
              >
                {/* 3D edge effect */}
              ...
              <motion.div
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-28 h-28 bg-gradient-to-tr from-[#B63106] to-[#60A5FA] rounded-3xl shadow-[0_20px_50px_-15px_rgba(182, 49, 6,0.4)] border border-[rgba(255,255,255,0.2)] z-10 flex items-center justify-center overflow-hidden"
              >
              ...
              >
                <div className="absolute w-6 h-6 bg-brand-card/40 rounded-full blur-md top-1 right-1"></div>
              </motion.div>

              {/* Floating Pill */}
              <motion.div
                style={{ x: sphereX, y: cubeY }}
                className="absolute top-1/4 left-8 w-12 h-20 rounded-full bg-gradient-to-b from-white to-[#F8FAFC] shadow-[0_10px_25px_-5px_rgba(182, 49, 6,0.1)] border border-white z-0 overflow-hidden"
              >
                <div className="absolute w-4 h-4 bg-brand-card rounded-full blur-sm top-2 left-2"></div>
              </motion.div>
            </div>
          </div>
          ...
          <div className="md:w-7/12 p-10 md:p-16 lg:p-20 flex flex-col justify-center bg-brand-card relative">
            ...
            <div>
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#191D20] text-white px-8 py-4 rounded-full font-semibold text-[15px] hover:bg-[#B63106] hover:shadow-[0_10px_30px_-10px_rgba(182, 49, 6,0.5)] transition-all duration-300 group"
              >
                Create your profile
