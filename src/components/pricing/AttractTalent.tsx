      ...
      <div className="max-w-[1080px] mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row rounded-[32px] border border-brand-border shadow-[0_12px_40px_rgb(0,0,0,0.04)] overflow-hidden bg-brand-card">
          ...
          <motion.div 
            ...
            className="w-full lg:w-1/2 flex flex-col p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-brand-border"
          >
            <div className="mb-8">
          ...
          >
            {/* Top Strip */}
            <div className="bg-[#FCE7F3] text-center py-2 text-[13px] font-bold text-brand-text">
              Add-on
            </div>
            
            <div className="flex flex-col flex-1 p-8 md:p-12 pt-6 md:pt-10">
              <div className="mb-8">
                <span className="text-[19px] font-bold text-brand-text block mb-6">Promoted Jobs</span>
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-[48px] md:text-[56px] font-bold text-brand-text leading-none tracking-tight">From ₹4,999</span>
                </div>
