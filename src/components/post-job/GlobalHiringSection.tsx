  ...
  return (
    <section className="py-12 md:py-16 bg-brand-card relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="relative h-[450px] w-full flex justify-center items-center bg-brand-bg rounded-3xl border border-brand-border p-8">
          ...
          <motion.div 
            ...
            className="w-full max-w-sm bg-brand-card border border-brand-border p-6 rounded-2xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] relative z-10"
          >
            <div className="mb-6">
              <h4 className="text-black font-semibold mb-3">Target Geography</h4>
              <div className="space-y-2">
                <div className="h-10 w-full bg-brand-bg rounded-lg border border-brand-border flex items-center justify-between px-3">
            ...
            <div>
              ...
              <div className="flex gap-2 flex-wrap">
                {["PST", "EST", "CST", "GMT", "CET"].map((tz, i) => (
                  <div 
                    key={tz}
                    className={`px-3 py-1.5 rounded-md text-xs font-semibold ${i < 3 ? 'bg-brand/10 text-[#B63106]' : 'bg-brand-bg text-brand-text-muted'}`}
                  >
                    {tz}
                  </div>
                ))}
