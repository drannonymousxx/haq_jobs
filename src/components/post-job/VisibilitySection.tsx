...
export function VisibilitySection() {
  return (
    <section className="py-12 md:py-16 bg-brand-card relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          ...
          <p className="text-lg text-brand-text-muted mt-2 max-w-md leading-relaxed">
        ...
        <div className="relative h-[500px] w-full bg-brand-bg rounded-3xl p-8 border border-brand-border flex flex-col justify-center gap-6">
          ...
          <motion.div 
            ...
            className="w-full bg-brand-card p-5 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-brand-border flex items-center justify-between"
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-brand-bg rounded-lg flex flex-wrap p-1 gap-0.5 border border-brand-border">
              ...
              <div>
                ...
                <p className="text-brand-text-muted text-xs mt-0.5">Corporate M&A • New York</p>
              </div>
            </div>
            <div className="px-4 py-2 bg-brand-bg text-black text-sm font-medium rounded-lg border border-brand-border cursor-pointer hover:bg-brand-bg transition-colors">
              Apply
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-brand-text-muted text-xs mt-0.5">Litigation • Remote</p>
              </div>
            </div>
            <div className="px-4 py-2 bg-brand-bg text-black text-sm font-medium rounded-lg border border-brand-border cursor-pointer hover:bg-brand-bg transition-colors">
              Apply
